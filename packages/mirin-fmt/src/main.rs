...
//!
//! Usage:
//!   mirin-fmt <file.mrn>...      format files in place
//!   mirin-fmt --check <file>...  exit non-zero if any file is not formatted
//!   mirin-fmt [-]                read stdin, write formatted source to stdout
//!
...
use mirin_fmt::{FormatError, format_str};
...
fn usage() -> String {
    "usage: mirin-fmt [--check] [<file.mrn>...]\n\
