...
const CLEAN: &[&str] = &[
    ...
    "signed.plr",
    "typed_literal.plr",
    "literal_inference.plr",
    "operators.plr",
    "trait_assoc_const.plr",
    "trait_generic.plr",
    "trait_bounded_impl.plr",
    "trait_concrete.plr",
    ...
    "const_arith.plr",
    "const_fn_if.plr",
    "const_out_params.plr",
    "const_record_config.plr",
    "accumulator.plr",
    "add_constant.plr",
    "const_then_clocked.plr",
    "counter.plr",
    "delay.plr",
    "delay_impl.plr",
    "dual_clock_lift.plr",
