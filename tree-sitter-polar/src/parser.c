...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_operator_identifier_character_set_1, 9, lookahead)) ADVANCE(29);
      if (set_contains(sym_identifier_character_set_1, 668, lookahead)) ADVANCE(31);
      END_STATE();
    case 2:
    ...
    case 31:
      ...
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(31);
      END_STATE();
    case 32:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(48),
  [20] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1, 0, 3),
  [25] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [27] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type_identifier, 1, 0, 2),
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 2, 0, 6),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_domain_tag, 2, 0, 7),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 3, 0, 9),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 10),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_expression, 3, 0, 11),
  ...
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_statement, 3, 0, 8),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_declaration, 7, 0, 12),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 6, 0, 5),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, 0, 0),
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 4, 0, 1),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3, 0, 4),
